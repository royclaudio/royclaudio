      ...
      <div className="primary-grid">
        <div className="description">
          ...
          <p>
            ...
            movies, for users to select, and from their selection, using AI, it
            will continue to generate a list of movies that cator to your
            preferences, using over 15 features, it will find you something to
            watch.
          </p>
        </div>
        <div className="gen-grid">
